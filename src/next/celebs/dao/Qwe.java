...
public class Qwe {
	...
	public static void main(String[] args) {
		...
		names.add("Charizma Carpenter");
		names.add("Lynda Carter");
		names.add("Cassie");
		...
		names.clear();
		for (Object n : nameArr) {
			String nn = (String)n;
			names.add(nn);
			System.out.println("names.add(\"" + nn + "\");");
		}
