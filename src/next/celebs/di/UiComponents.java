...
import next.celebs.page.AzNamePage;
import next.celebs.page.AzPage;
import next.celebs.page.BrandingPage;
import next.celebs.page.FeelLuckyPage;
import next.celebs.page.FrontPage;
import next.celebs.page.FrontTopMenu;
import next.celebs.page.ImagesPage;
import next.celebs.page.LeftMenuImpl;
import next.celebs.page.PageManager;
import next.celebs.page.RedcarpetOptionPage;
import next.celebs.page.RedcarpetPage;
import next.celebs.page.SearchPage;
import next.celebs.page.SettingsPage;
import next.celebs.page.SubMenuPage;
import next.celebs.page.SwimwearPage;
import next.celebs.page.TopMenu;
import next.celebs.page.WallpaperPage;
import next.celebs.page.WikiPage;
